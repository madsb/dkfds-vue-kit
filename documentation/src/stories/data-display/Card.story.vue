...
import { ref } from 'vue'
import { FdsCard, FdsCardGroup, FdsButton } from '@madsb/dkfds-vue-kit'
      ...
      <div class="container py-6">
        <div class="row">
          ...
          <div class="col-12 col-md-6 col-xl-3 mb-5">
            ...
            <FdsCard header="Article Title" subheader="News" to="#article-link">
              Click this card to navigate to an article.
            </FdsCard>
          </div>
          <div class="col-12 col-md-6 col-xl-3 mb-5">
            <h3 class="h5 mb-2">Card with Image</h3>
            <FdsCard header="Visual Content" subheader="Media">
              <template #image>
                <div
                  style="
                    width: 100%;
          ...
          <div class="col-12 col-md-6 col-xl-3 mb-5">
            ...
            <FdsCard header="Interactive Card" subheader="Actions">
        ...
        <p class="mt-4 mb-0">
          The card component follows DKFDS v11 design specifications. Try switching themes using the
          global theme switcher to see how cards adapt to different contexts.
        </p>
      </div>
    </Variant>
      ...
      <div class="container py-6">
        ...
        <FdsCardGroup>
          ...
          <FdsCard header="Service 3" subheader="Category" to="#service-3">
            Description of the third service with longer content that demonstrates how cards handle
        ...
        <FdsCardGroup type="deck">
          <FdsCard header="Short Content" subheader="Brief"> Brief description. </FdsCard>
          <FdsCard header="Medium Content" subheader="Moderate">
            This card has a moderate amount of content that extends to multiple lines for
            demonstration.
          </FdsCard>
          <FdsCard header="Long Content" subheader="Extended">
            This card contains much more content that spans several lines and demonstrates how the
            deck layout ensures all cards maintain equal heights regardless of content length.
          </FdsCard>
        </FdsCardGroup>
        ...
        <FdsCardGroup type="columns">
          ...
          <FdsCard header="Quick Update" subheader="2 hours ago"> Brief update. </FdsCard>
          <FdsCard header="Feature Story" subheader="Yesterday">
            Longer feature story with detailed content that spans multiple lines and demonstrates
        ...
        <p class="mt-4 mb-0">
          Card groups provide responsive layouts. Resize the viewport to see how cards adapt. Click
          count: {{ clickCount }}
        </p>
      </div>
    </Variant>
    ...
    <Variant title="Navigation & Links" icon="carbon:arrow-forward">
      <div class="container py-6">
        <div>
          ...
          <FdsCardGroup>
            <FdsCard header="Dashboard" subheader="Overview" to="#dashboard" icon="arrow-forward">
              View your dashboard with latest statistics and information.
            </FdsCard>
            <FdsCard header="Settings" subheader="Configuration" to="#settings">
          ...
          >
            ...
            The long variant provides an extended layout perfect for detailed content, featured
            articles, or prominent information that needs more visual space and attention. This
            variant works well for hero sections and detailed explanations.
            <template #actions>
        ...
        <p class="mt-4 mb-0">
          Navigation cards automatically detect internal vs external links and show appropriate
          icons.
        </p>
      </div>
    </Variant>
        ...
        <div>
          ...
          <FdsCardGroup type="deck">
            ...
            <FdsCard header="Text Only" subheader="Simple">
              This card contains only text content without any additional visual elements or
              actions.
            </FdsCard>
