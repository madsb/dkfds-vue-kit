...
const themeLoaders: Record<DKFDSTheme, () => Promise<string>> = {
  ...
  virkdk: async () => (await import('../../../node_modules/dkfds/dist/css/dkfds-virkdk.css?url')).default,
  borgerdk: async () => (await import('../../../node_modules/dkfds/dist/css/dkfds-borgerdk.css?url')).default
}
